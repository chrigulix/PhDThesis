...
void DrawCosmicPandoraNu()
{
    ...
    CosmicHistLabels.push_back("Data Off-Beam BNBEXT All PandoraNu");
    CosmicHistLabels.push_back("In Time Corsika All PandoraNu");
    CosmicHistLabels.push_back("Cosmic Systematics All PandoraNu");
...
//     Header->SetTextSize(0.05);
    ...
    pad1TrackRange->Draw();
    pad1TrackRange->cd();
    CosmicTrackRange.at(0) -> SetTitle("PandoraNu Track Range");
    ...
    C0->SaveAs("../images/FirstCCInclusive/CosmicBackground/CosmicTrackRangePandoraNu.pdf");
    ...
    pad1CosTheta->Draw();
    pad1CosTheta->cd();
    CosmicCosTheta.at(0) -> SetTitle("PandoraNu cos(#theta)");
...
//     CosmicCosTheta.at(2) -> GetYaxis() -> SetRangeUser(0.52,1.15);
    ...
    C1->SaveAs("../images/FirstCCInclusive/CosmicBackground/CosmicCosThetaPandoraNu.pdf");
    ...
    pad1Theta->Draw();
    pad1Theta->cd();
    CosmicTheta.at(0) -> SetTitle("PandoraNu #theta-Angle");
...
//     CosmicTheta.at(2) -> GetYaxis() -> SetRangeUser(0.25,1.25);
    ...
    C2->SaveAs("../images/FirstCCInclusive/CosmicBackground/CosmicThetaPandoraNu.pdf");
...
//     CosmicPhi.at(2) -> GetYaxis() -> SetRangeUser(0.25,1.25);
    ...
    Line1Phi -> Draw("SAME");
    C3->SaveAs("../images/FirstCCInclusive/CosmicBackground/CosmicPhiPandoraNu.pdf");
    ...
    pad1Momentum->Draw();
    pad1Momentum->cd();
    CosmicMomentum.at(0) -> SetTitle("PandoraNu Momentum");
...
//     CosmicMomentum.at(2) -> GetYaxis() -> SetRangeUser(0.25,1.25);
    ...
    C4->SaveAs("../images/FirstCCInclusive/CosmicBackground/CosmicMomentumPandoraNu.pdf");
    ...
    pad1TrackLength->cd();
    CosmicTrackLength.at(0) -> SetTitle("PandoraNu Track Length");
...
//     CosmicTrackLength.at(2) -> GetYaxis() -> SetRangeUser(0.25,1.25);
    ...
    C5->SaveAs("../images/FirstCCInclusive/CosmicBackground/CosmicTrackLengthPandoraNu.pdf");
    ...
    pad1XVtxPosition->cd();
    CosmicXVtxPosition.at(0) -> SetTitle("PandoraNu Vertex Position in X");
...
//     CosmicXVtxPosition.at(2) -> GetXaxis() -> SetRangeUser(0,500);
    ...
    C6->SaveAs("../images/FirstCCInclusive/CosmicBackground/CosmicXVtxPositionPandoraNu.pdf");
    ...
    pad1YVtxPosition->cd();
    CosmicYVtxPosition.at(0) -> SetTitle("PandoraNu Vertex Position in Y");
...
//     CosmicYVtxPosition.at(2) -> GetXaxis() -> SetRangeUser(0,500);
    ...
    C7->SaveAs("../images/FirstCCInclusive/CosmicBackground/CosmicYVtxPositionPandoraNu.pdf");
    ...
    pad1ZVtxPosition->cd();
    CosmicZVtxPosition.at(0) -> SetTitle("PandoraNu Vertex Position in Z");
...
//     CosmicZVtxPosition.at(2) -> GetXaxis() -> SetRangeUser(0,500);
    ...
    C8->SaveAs("../images/FirstCCInclusive/CosmicBackground/CosmicZVtxPositionPandoraNu.pdf");
